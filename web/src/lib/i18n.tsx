...
const en = {
  ...
  'landing.heroSubtitle':
    'Save splits every payment you receive: part stays ready to spend, part goes straight into a yield-earning savings vault on EVM Sepolia.',
  'landing.cta': 'Open the app',
  'landing.navHow': 'How it works',
  'landing.navProtocols': 'Protocols',
  'landing.navCompare': 'Why Save',
  ...
  'landing.step1Body': 'Link any EVM Sepolia wallet in seconds. No sign-up, no custody.',
  ...
  'landing.protocolsCaption':
    'Your savings route into audited, on-chain protocols on EVM Sepolia - never a black box.',
  ...
  'landing.footerTagline': 'Programmable savings on every payment, on EVM Sepolia.',
  ...
  'landing.footer': 'Built on EVM Sepolia testnet. Demo funds only, no real money.',
  ...
  'onboarding.step1Caption': 'Use MetaMask or any EVM Sepolia wallet to get started.',
  ...
  'settings.networkTestnet': 'EVM Sepolia Testnet',
  'settings.networkTestnetHint':
    'This app runs on EVM Sepolia testnet. Funds here are for testing only and have no real value.',
  'settings.contract': 'Contract',
  'settings.viewExplorer': 'View on explorer',
  'settings.copy': 'Copy',
  'settings.copied': 'Copied',
  'settings.about': 'Save is a demo of programmable savings on EVM Sepolia testnet.',
  'settings.byline': 'Save by save-team',
  ...
  'errors.invalidPayAddress': 'The address in this payment link is not a valid EVM Sepolia address.',
...
const id = {
  ...
  'landing.heroSubtitle':
    'Save membagi setiap pembayaran yang kamu terima: sebagian siap dipakai, sebagian langsung masuk brankas tabungan yang menghasilkan di EVM Sepolia.',
  'landing.cta': 'Buka aplikasi',
  'landing.navHow': 'Cara kerja',
  'landing.navProtocols': 'Protokol',
  'landing.navCompare': 'Kenapa Save',
  ...
  'landing.step1Body': 'Sambungkan wallet EVM Sepolia apa saja dalam hitungan detik. Tanpa daftar, tanpa custody.',
  ...
  'landing.protocolsCaption':
    'Tabunganmu disalurkan ke protokol on-chain yang teraudit di EVM Sepolia - bukan kotak hitam.',
  ...
  'landing.footerTagline': 'Tabungan terprogram dari setiap pembayaran, di EVM Sepolia.',
  ...
  'landing.footer': 'Dibangun di EVM Sepolia testnet. Dana demo saja, bukan uang sungguhan.',
  ...
  'onboarding.step1Caption': 'Pakai MetaMask atau dompet EVM Sepolia lain untuk mulai.',
  ...
  'settings.networkTestnet': 'EVM Sepolia Testnet',
  'settings.networkTestnetHint':
    'Aplikasi ini jalan di EVM Sepolia testnet. Dana di sini cuma buat uji coba dan tidak bernilai sungguhan.',
  'settings.contract': 'Kontrak',
  'settings.viewExplorer': 'Lihat di explorer',
  'settings.copy': 'Salin',
  'settings.copied': 'Tersalin',
  'settings.about': 'Save adalah demo tabungan terprogram di EVM Sepolia testnet.',
  'settings.byline': 'Save oleh Cyphras Labs',
  'settings.langEn': 'English',
  'settings.langId': 'Bahasa Indonesia',
  ...
  'errors.invalidPayAddress': 'Alamat di tautan pembayaran ini bukan alamat EVM Sepolia yang valid.',
...
const zh = {
  ...
  'landing.heroSubtitle': 'Save 会自动分配您收到的每一笔付款：一部分可供随时消费，另一部分直接存入 EVM Sepolia 上的收益储蓄库。',
  'landing.cta': '打开应用',
  'landing.navHow': '工作原理',
  'landing.navProtocols': '支持协议',
  'landing.navCompare': '为什么选择 Save',
  'landing.demoLabel': '有人刚刚向您支付了',
  'landing.howTitle': '工作原理',
  'landing.howCaption': '从收到付款到自动赚取收益，仅需四个自动化步骤。',
  'landing.step1Title': '连接您的钱包',
  'landing.step1Body': '数秒内即可关联任何 EVM Sepolia 钱包。无需注册，无托管风险。',
  'landing.step2Title': '接收付款',
  'landing.step2Body': '分享您的收款链接，或直接接收 USDC 稳定币。',
  ...
  'landing.footerTagline': 'EVM Sepolia 上的可编程每一笔自动储蓄应用。',
  ...
  'onboarding.step1Caption': '使用 MetaMask 或任何 EVM Sepolia 钱包开始。',
  'onboarding.step2Title': '获取测试代币',
  'onboarding.step2Caption': '从水龙头免费获得测试 USDC，以及用于支付 Gas 费的 ETH。',
  ...
  'balances.rateCaption': '估算为每 USDC {amount}',
  ...
  'withdraw.sharesHint': '储蓄是以金库份额的形式持有的；您提取的 USDC 将包含所有已赚取的收益。',
  ...
  'yield.mainnetRefCaption': '主网参考显示真实主网资金池的当前年化率以供参考。您的仓位目前运行在 Sepolia 测试网上。',
  ...
  'settings.currencyUsdc': '美元稳定币 (USDC)',
  'settings.currencyCny': '人民币 (CNY)',
  'settings.preferencesHint': '语言和法币设置仅影响前端金额 of 格式，不影响您的钱包或链上数据。',
  'settings.network': '当前网络',
  'settings.networkTestnet': 'EVM Sepolia 测试网',
  'settings.networkTestnetHint': 'Save 目前运行在以太坊 Sepolia 测试网上。代币仅作为测试使用，无真实法币价值。',
  'settings.contract': '智能合约地址',
  'settings.viewExplorer': '在浏览器中查看',
  'settings.copy': '复制',
  'settings.copied': '已成功复制',
  'settings.about': 'Save 是一款在您每次接收付款时自动提取储蓄的应用程序。利用 iExec Nox 提供的机密智能合约保护隐私。',
  'settings.byline': '由 WTF iExec Hackathon 2026 团队开发。',
  'settings.langEn': 'English',
  'settings.langId': 'Bahasa Indonesia',
  'settings.langZh': '简体中文',
  ...
  'common.amountPlaceholder': '输入 USDC 金额',
