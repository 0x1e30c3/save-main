...
const en = {
  ...
  'yield.badgeUnavailable': 'Unavailable',
  ...
  'yield.depositTitle': 'Deposit savings to yield',
  'yield.availableSavings': 'Available savings',
  'yield.amount': 'Amount to deposit',
  'yield.max': 'Max',
  'yield.slippage': 'Slippage tolerance',
  'yield.outputToken': 'Output token',
  'yield.fromConfig': 'from config',
  'yield.tokenOutPlaceholder': '0x... output token address',
  'yield.tokenOutRequired': 'Set an output token to continue.',
  'yield.protocol': 'Protocol',
  'yield.adapter': 'Adapter',
  'yield.depositButton': 'Deposit to yield',
  'yield.depositHint': 'This swaps your FXRP savings through the adapter into the selected output token or vault.',
  'yield.targetUnavailable': 'This yield source is not available on the testnet right now. Choose another source.',
  'yield.vault': 'Vault',
  'yield.firelightVault': 'Firelight ERC-4626 vault',
  ...
  'faucet.caption': 'Claim free C2FLR for gas and FXRP to try YourSave on Flare Coston2.',
  'faucet.wallet': 'Your wallet',
  'faucet.c2flr': 'C2FLR balance',
  'faucet.c2flrCaption': 'Native token for transaction fees on Coston2.',
  'faucet.fxrp': 'FXRP balance',
  'faucet.fxrpCaption': 'FAssets-wrapped XRP used for payments and savings.',
  'faucet.claimTitle': 'Claim from Flare faucet',
  'faucet.claimCaption': 'Open the official Coston2 faucet, enter your address, and request both C2FLR and FXRP. Come back and click refresh.',
  'faucet.openButton': 'Open Flare faucet',
  'faucet.ready': 'Your wallet looks funded. You can start using the app.',
  'faucet.backToApp': 'Back to app',
  'faucet.viewOnExplorer': 'View address on explorer',
  'faucet.checkFxrpToken': 'Check FXRP token contract',
  ...
  'success.yieldDeposited': 'Savings deposited to yield',
  ...
  'errors.wrongNetwork': 'Please switch your wallet to Flare Coston2 network.',
  'errors.vaultNotAccepting': 'This vault is not accepting deposits right now. Try another yield source.',
  'errors.slippageTooLow': 'The swap fell below your set minimum. Increase slippage or try again.',
  'errors.insufficientAllowance': 'Token approval failed. Please approve the token spend in your wallet.',
  'errors.txReverted': 'Transaction failed on-chain. Please try again.',
...
const id = {
  ...
  'yield.badgeUnavailable': 'Tidak tersedia',
  ...
  'yield.depositTitle': 'Deposit tabungan ke yield',
  'yield.availableSavings': 'Tabungan tersedia',
  'yield.amount': 'Jumlah deposit',
  'yield.max': 'Maks',
  'yield.slippage': 'Toleransi slippage',
  'yield.outputToken': 'Token hasil',
  'yield.fromConfig': 'dari config',
  'yield.tokenOutPlaceholder': '0x... alamat token hasil',
  'yield.tokenOutRequired': 'Atur token hasil untuk melanjutkan.',
  'yield.protocol': 'Protokol',
  'yield.adapter': 'Adapter',
  'yield.depositButton': 'Deposit ke yield',
  'yield.depositHint': 'Ini menukar tabungan FXRP-mu melalui adapter menjadi token hasil atau vault yang dipilih.',
  'yield.targetUnavailable': 'Sumber yield ini belum tersedia di testnet saat ini. Pilih sumber lain.',
  'yield.vault': 'Vault',
  'yield.firelightVault': 'Vault ERC-4626 Firelight',
  ...
  'faucet.title': 'Faucet testnet',
  'faucet.caption': 'Klaim C2FLR gratis untuk gas dan FXRP untuk mencoba YourSave di Flare Coston2.',
  'faucet.wallet': 'Dompetmu',
  'faucet.c2flr': 'Saldo C2FLR',
  'faucet.c2flrCaption': 'Token native untuk biaya transaksi di Coston2.',
  'faucet.fxrp': 'Saldo FXRP',
  'faucet.fxrpCaption': 'XRP terbungkus FAssets untuk pembayaran dan tabungan.',
  'faucet.claimTitle': 'Klaim dari faucet Flare',
  'faucet.claimCaption': 'Buka faucet Coston2 resmi, masukkan alamat dompetmu, dan minta C2FLR serta FXRP. Kembali ke sini lalu klik segarkan.',
  'faucet.openButton': 'Buka faucet Flare',
  'faucet.ready': 'Dompetmu sudah terisi. Kamu bisa mulai menggunakan aplikasi.',
  'faucet.backToApp': 'Kembali ke aplikasi',
  'faucet.viewOnExplorer': 'Lihat alamat di explorer',
  'faucet.checkFxrpToken': 'Cek kontrak token FXRP',
  ...
  'success.yieldDeposited': 'Tabungan berhasil deposit ke yield',
  ...
  'errors.wrongNetwork': 'Harap ganti dompetmu ke jaringan Flare Coston2.',
  'errors.vaultNotAccepting': 'Vault ini sedang tidak menerima deposit. Coba sumber yield lain.',
  'errors.slippageTooLow': 'Pertukaran jatuh di bawah batas minimummu. Naikkan slippage atau coba lagi.',
  'errors.insufficientAllowance': 'Persetujuan token gagal. Setujui pengeluaran token di dompetmu.',
  'errors.txReverted': 'Transaksi gagal di on-chain. Coba lagi.',
  'errors.unauthorized': 'Kamu tidak memiliki izin untuk melakukan aksi ini.',
...
const zh = {
  ...
  'yield.depositTitle': '将储蓄存入收益',
  'yield.availableSavings': '可用储蓄',
  'yield.amount': '存入数量',
  'yield.max': '全部',
  'yield.slippage': '滑点容忍度',
  'yield.outputToken': '输出代币',
  'yield.fromConfig': '来自配置',
  'yield.tokenOutPlaceholder': '0x... 输出代币地址',
  'yield.tokenOutRequired': '请设置输出代币地址以继续。',
  'yield.protocol': '协议',
  'yield.adapter': '适配器',
  'yield.depositButton': '存入收益',
  'yield.depositHint': '此操作通过适配器将您的 FXRP 储蓄兑换为所选输出代币或金库。',
  'yield.targetUnavailable': '该收益来源当前在测试网上不可用，请选择其他来源。',
  'yield.vault': '金库',
  'yield.firelightVault': 'Firelight ERC-4626 金库',
  ...
  'faucet.title': '测试网水龙头',
  'faucet.caption': '领取免费的 C2FLR 作为 Gas 费，以及用于体验 YourSave 的 FXRP。',
  'faucet.wallet': '您的钱包',
  'faucet.c2flr': 'C2FLR 余额',
  'faucet.c2flrCaption': 'Coston2 上支付交易费用的原生代币。',
  'faucet.fxrp': 'FXRP 余额',
  'faucet.fxrpCaption': '用于支付和储蓄的 FAssets 封装 XRP。',
  'faucet.claimTitle': '从 Flare 水龙头领取',
  'faucet.claimCaption': '打开官方 Coston2 水龙头，输入您的钱包地址，同时申请 C2FLR 和 FXRP。完成后返回此处点击刷新。',
  'faucet.openButton': '打开 Flare 水龙头',
  'faucet.ready': '钱包似乎已有足够测试币，可以开始使用应用了。',
  'faucet.backToApp': '返回应用',
  'faucet.viewOnExplorer': '在浏览器中查看地址',
  'faucet.checkFxrpToken': '查看 FXRP 代币合约',

  'success.paid': '付款成功接收并自动分流！',
  'success.linkPaid': '付款成功发送！',
  'success.withdrewSpend': '可消费余额成功提取至钱包！',
  'success.withdrewSavings': '储蓄资金成功提取至钱包！',
  'success.yieldDeposited': '储蓄已成功存入收益！',

  'errors.generic': '发生错误，请重试。',
  'errors.wrongNetwork': '请将钱包切换到 Flare Coston2 网络。',
  'errors.vaultNotAccepting': '该金库暂时不接受存款，请尝试其他收益来源。',
  'errors.slippageTooLow': '交易滑点低于您设置的最低限度，请提高滑点或重试。',
  'errors.insufficientAllowance': '代币授权失败，请在钱包中授权代币支出。',
  'errors.txReverted': '链上交易失败，请重试。',
  'errors.unauthorized': '你没有权限执行此操作。',
...
export function formatMoney(
  ...
  if (currency === 'fxrp') {
    const fxrp = Number(amount) / 1e6
    const formatted = new Intl.NumberFormat(intlLocale(locale), {
      maximumFractionDigits: 4,
    }).format(fxrp)
    return `${formatted} FXRP`
  }
  const units = Number(amount) / 1e6
  if (currency === 'usdc') {
    const formatted = new Intl.NumberFormat(intlLocale(locale), {
