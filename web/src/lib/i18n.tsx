...
const en = {
  ...
  'landing.heroSubtitle':
    'Save splits every payment you receive: part stays ready to spend, part goes straight into a yield-earning savings vault on Stellar.',
  ...
  'settings.about': 'Save is a demo of programmable savings on Stellar testnet.',
...
const id = {
  ...
  'landing.heroSubtitle':
    'Save membagi setiap pembayaran yang kamu terima: sebagian siap dipakai, sebagian langsung masuk brankas tabungan yang menghasilkan di Stellar.',
  ...
  'settings.about': 'Save adalah demo tabungan terprogram di Stellar testnet.',
...
const vi = {
  ...
  'landing.heroSubtitle':
    'Save tự động chia mỗi khoản thanh toán bạn nhận được: một phần luôn sẵn sàng để chi tiêu, phần còn lại vào thẳng kho tiết kiệm sinh lời trên Stellar.',
  ...
  'settings.about': 'Save là bản demo về tiết kiệm có thể lập trình trên Stellar testnet.',
...
const fil = {
  ...
  'landing.heroSubtitle':
    'Hinahati ng Save ang bawat payment na natatanggap mo: may bahaging pwede mong gastusin agad, at may bahaging diretso sa isang savings vault sa Stellar na kumikita ng yield.',
  ...
  'settings.about': 'Ang Save ay isang demo ng programmable savings sa Stellar testnet.',
  'settings.byline': 'Save by Cyphras Labs',
  'settings.langEn': 'English',
  'settings.langId': 'Bahasa Indonesia',
  'settings.langVi': 'Tiếng Việt',
