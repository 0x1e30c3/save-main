...
const en = {
  ...
  'settings.byline': 'Save by Cyphras Labs',
...
const vi = {
  ...
  'landing.heroSubtitle':
    'Save tự động chia mỗi khoản thanh toán bạn nhận được: một phần luôn sẵn sàng để chi tiêu, phần còn lại vào thẳng kho tiết kiệm sinh lời trên EVM Sepolia.',
  'landing.cta': 'Mở ứng dụng',
  'landing.navHow': 'Cách hoạt động',
  'landing.navProtocols': 'Giao thức',
  'landing.navCompare': 'Vì sao chọn Save',
  ...
  'landing.step1Body': 'Liên kết bất kỳ ví EVM Sepolia nào trong vài giây. Không đăng ký, không lưu ký.',
  ...
  'landing.protocolsCaption':
    'Tiền tiết kiệm của bạn được dẫn vào các giao thức on-chain đã kiểm toán trên EVM Sepolia - không phải hộp đen.',
  ...
  'landing.footerTagline': 'Tiết kiệm lập trình được từ mỗi khoản thanh toán, trên EVM Sepolia.',
  ...
  'landing.footer': 'Xây dựng trên EVM Sepolia testnet. Chỉ là tiền demo, không phải tiền thật.',
  ...
  'onboarding.step1Caption': 'Dùng MetaMask hoặc bất kỳ ví EVM Sepolia nào để bắt đầu.',
  ...
  'pay.connectCaption': 'Bạn thanh toán trực tiếp từ ví EVM Sepolia của mình. Không cần tạo tài khoản.',
  ...
  'pay.createOwn': 'Tạo Save của riêng bạn',
  'pay.invalidTitle': 'Link thanh toán này có vẻ không hợp lệ',
  'pay.goHome': 'Đi đến Save',
  ...
  'settings.networkTestnet': 'EVM Sepolia Testnet',
  'settings.networkTestnetHint':
    'Ứng dụng này chạy trên EVM Sepolia testnet. Số tiền ở đây chỉ dùng để thử nghiệm và không có giá trị thật.',
  'settings.contract': 'Hợp đồng',
  'settings.viewExplorer': 'Xem trên explorer',
  'settings.copy': 'Sao chép',
  'settings.copied': 'Đã sao chép',
  'settings.about': 'Save là bản demo về tiết kiệm có thể lập trình trên EVM Sepolia testnet.',
  'settings.byline': 'Save bởi Cyphras Labs',
  'settings.langEn': 'English',
  'settings.langId': 'Bahasa Indonesia',
  'settings.langVi': 'Tiếng Việt',
  'settings.langFil': 'Filipino',
  ...
  'errors.invalidPayAddress': 'Địa chỉ trong link thanh toán này không phải là địa chỉ EVM Sepolia hợp lệ.',
...
const fil = {
  ...
  'landing.heroSubtitle':
    'Hinahati ng Save ang bawat payment na natatanggap mo: may bahaging pwede mong gastusin agad, at may bahaging diretso sa isang savings vault sa EVM Sepolia na kumikita ng yield.',
  'landing.cta': 'Buksan ang app',
  'landing.navHow': 'Paano gumagana',
  'landing.navProtocols': 'Mga protocol',
  'landing.navCompare': 'Bakit Save',
  ...
  'landing.step1Body': 'I-link ang kahit anong EVM Sepolia wallet sa ilang segundo lang. Walang sign-up, walang custody.',
  ...
  'landing.protocolsCaption':
    'Napupunta ang savings mo sa mga audited, on-chain na protocol sa EVM Sepolia - hindi black box.',
  ...
  'landing.footerTagline': 'Programmable savings sa bawat payment, sa EVM Sepolia.',
  ...
  'landing.footer': 'Gawa gamit ang EVM Sepolia testnet. Demo funds lang, walang totoong pera.',
  ...
  'onboarding.step1Caption': 'Gamitin ang MetaMask o kahit anong EVM Sepolia wallet para makapagsimula.',
  ...
  'pay.connectCaption': 'Direktang magbabayad ka mula sa sarili mong EVM Sepolia wallet. Hindi na kailangan ng account.',
  'pay.successTitle': 'Naipadala ang bayad',
  'pay.successBody': 'Nakarating na ang bayad mo kay {name}.',
  'pay.payAgain': 'Magbayad ulit',
  'pay.createOwn': 'Gumawa ng sarili mong Save',
  'pay.invalidTitle': 'Mukhang sira ang payment link na ito',
  'pay.goHome': 'Pumunta sa Save',
  ...
  'settings.networkTestnet': 'EVM Sepolia Testnet',
  'settings.networkTestnetHint':
    'Tumatakbo ang app na ito sa EVM Sepolia testnet. Ang mga funds dito ay pantesting lang at walang totoong value.',
  'settings.contract': 'Contract',
  'settings.viewExplorer': 'Tingnan sa explorer',
  'settings.copy': 'Kopyahin',
  'settings.copied': 'Nakopya',
  'settings.about': 'Ang Save ay isang demo ng programmable savings sa EVM Sepolia testnet.',
  'settings.byline': 'Save by Cyphras Labs',
  'settings.langEn': 'English',
  'settings.langId': 'Bahasa Indonesia',
  'settings.langVi': 'Tiếng Việt',
  ...
  'errors.invalidPayAddress': 'Ang address sa payment link na ito ay hindi valid na EVM Sepolia address.',
