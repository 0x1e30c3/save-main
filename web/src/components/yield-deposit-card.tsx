...
export function YieldDepositCard({
  ...
  const handleDeposit = async () => {
    ...
    try {
      ...
      // amountOutMin = 0 means no slippage protection; for hackathon/demo we accept any output
      // In production this should quote the exact output and apply slippage.
